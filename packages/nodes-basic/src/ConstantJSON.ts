import type { ITextWidget, IWidget, OptionalSlots, PropertyLayout, SlotLayout, Vector2 } from '@litegraph-ts/core'
import { BuiltInSlotShape, LGraphNode, LiteGraph } from '@litegraph-ts/core'
