import type { INodeInputSlot, INodeOutputSlot, LConnectionKind, LLink, SlotLayout } from '@litegraph-ts/core'
import { ITextWidget, LGraphNode, LiteGraph, PropertyLayout } from '@litegraph-ts/core'
