import type { INodeInputSlot, INodeOutputSlot, ITextWidget, LLink, PropertyLayout, SlotLayout } from '@litegraph-ts/core'
import { BuiltInSlotType, LConnectionKind, LGraphNode, LiteGraph } from '@litegraph-ts/core'
